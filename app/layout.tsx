...
export const metadata: Metadata = {
  ...
  description:
    "Andrew Jones is a product manager with ten years of experience shipping 0→1 products, from enterprise and consumer AI to enterprise SaaS.",
  openGraph: {
    siteName: "Andrew Jones",
    type: "website",
  },
};
